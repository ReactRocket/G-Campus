...
const fields = [
    {
        text: 'Dashboard',
        link: '/admin',
        svg: <svg className="-ml-1 h-6 w-6" viewBox="0 0 24 24" fill="none">
            <path
                d="M6 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8ZM6 15a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2v-1Z"
                className="dark:fill-slate-600 fill-current "
            ></path>
            <path
                d="M13 8a2 2 0 0 1 2-2h1a2 2 0 0 1 2 2v1a2 2 0 0 1-2 2h-1a2 2 0 0 1-2-2V8Z"
                className="fill-current  group-hover:text-cyan-300 hover:text-cyan-400"
            ></path>
            <path
    ...
    },
    {
        text: 'Student',
        link: '/admin/student',
        svg: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-people-fill   group-hover:text-cyan-300 hover:text-cyan-400" viewBox="0 0 16 16">
    ...
    },
    {
        text: 'Faculty',
        link: '/admin/faculty',
        svg: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-workspace   group-hover:text-cyan-300 hover:text-cyan-400" viewBox="0 0 16 16">
    ...
    },
    {
        text: 'Notices',
        link: '/admin/notice',
        svg: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-bell-fill   group-hover:text-cyan-300 hover:text-cyan-400" viewBox="0 0 16 16">
    ...
    },
    {
        text: 'Feedback',
        link: '/admin/feedback',
        svg: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chat-right-text-fill   group-hover:text-cyan-300 hover:text-cyan-400" viewBox="0 0 16 16">
    ...
    },
    {
        text: 'Gallery',
        link: '/admin/gallery',
        svg: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-images hover:text-cyan-400 group-hover:text-cyan-300" viewBox="0 0 16 16">
...
const AdminPanel = ({ isMenuOpen, setIsMenuOpen }) => {
    ...
    return (
        <div className="bg-gray-100 dark:bg-gray-900">
            <aside
                className={`fixed top-0 z-10  flex h-screen w-full flex-col justify-between border-r bg-white px-6 pb-3 transition duration-300 md:w-4/12 ${!isMenuOpen && "ml-[-100%]"} lg:ml-0  lg:w-[25%] xl:w-[20%] 2xl:w-[15%] dark:bg-gray-800 dark:border-gray-700`}
            >
                <div>

                    <p className='w-full mt-5 flex justify-end items-center  lg:hidden'><svg
                    ...
                    <div className=" mt-8 text-center">
                        ...
                        <span className=" text-gray-500 font-bold text-2xl lg:text-xl">Admin</span>
                    </div>
                            ...
                            fields.map((field, i) => {
                                return (
                                    <li key={i}>
                                        <Link to={field.link}
                                            onClick={() => setIsMenuOpen(false)}
                                            className={`${location.pathname === field.link ? 'relative flex items-center space-x-4 rounded-xl bg-gradient-to-r from-sky-600 to-cyan-400 px-4 py-3 text-white' : 'group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600 dark:text-gray-300'}`}
                                        >
                                            {
                                                field.svg
                                            }
            ...
            <div className="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
                <div className="sticky top-0 h-16 border-b bg-white dark:bg-gray-800 dark:border-gray-700 lg:py-2.5">
                    <div className="flex items-center justify-between space-x-4 px-6 2xl:container">
                        ...
                        <button onClick={() => setIsMenuOpen(true)} className="-mr-2 h-16 w-12 border-r lg:hidden dark:border-gray-700 dark:text-gray-300">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
