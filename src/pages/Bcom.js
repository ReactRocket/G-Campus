                      ...
                      <div className="max-w-xl text-center lg:text-left">
                        <div>
                          ...
                          <p className="max-w-xl text-xl mt-4  tracking-tight text-gray-600">
                            "Bachelor of Commerce (BCom) is a highly
                            sought-after course among students who have
                            successfully completed their Class 12th, with a
                            focus on Commerce or related subjects in Senior
                            Secondary Education. If you aspire to build a career
                            in the dynamic field of commerce, then opting for a
                            BCom course is an excellent choice.
                          </p>
                        </div>
                          ...
                          >
                            <li>
                              ...
                              <div className="mt-2 text-lg text-gray-500">
                                In finance, an account is a formal record used
                                to systematically track and summarize financial
                                transactions. These transactions can include
                                monetary exchanges, purchases, sales, and
                                various other financial activities.
                              </div>
                            </li>
                            <li>
                              <div>
                              ...
                              <div className="mt-2 text-lg text-gray-500">
                                ...
                                involves collecting, analyzing, interpreting,
                                presenting, and organizing data. It provides
                            ...
                            <li>
                              ...
                              <div className="mt-2 text-lg text-gray-500">
                                Economics is a social science that analyzes how
                                individuals, businesses, governments, and
                                societies allocate scarce resources to satisfy
                                their needs and wants. It encompasses the study
                                of production.
                              </div>
                            </li>
                            <li>
                              ...
                              <div className="mt-2 text-lg text-gray-500">
                                A Bachelor of Commerce (BCom) degree with a
                                specialization in Marketing is designed to
