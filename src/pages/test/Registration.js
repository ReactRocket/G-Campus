            ...
            <div className="grid grid-cols-3 mt-5  h-[17%]">
              ...
              <div>
                <input
                  ...
                  id="firstName"
                  value=""
                  className="border text-lg px-2 py-1 rounded border-black block focus:border-sky-700 focus:ring-1 placeholder:text-sky-700 outline-none"
                />
