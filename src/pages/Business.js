...
import bba3 from "../resources/images/bba/bb3.svg";
import bba4 from "../resources/images/bba/bba4.svg";
                      ...
                      <div className="max-w-xl text-center lg:text-left">
                        <div>
                          ...
                          <p className="max-w-xl text-lg mt-4 tracking-tight text-gray-600">
                            BBA. : BBA Aviation BBA in Finance BBA International
                            Business BBA in Airport Management BBA Logistics BBA
                            in Digital Marketing BBA in Marketing BBA MBA
                            Integrated Course BBA in HR BBA stands for Bachelor
                          ...
                          >
                            ...
                            <li>
                              ...
                              <div className="mt-2 text-base text-gray-500">
                                ...
                                corporate law, is a field of law that governs
                                the rights, relations, and conduct of
                            ...
                            <li>
                              ...
                              <div className="mt-2 text-base text-gray-500">
                                Sales and consumer protection laws are essential
                                components of business law that aim to regulate
                            ...
                            <li>
                              ...
                              <div className="mt-2 text-base text-gray-500">
                                Presentation skills are essential in various
                                aspects of professional and academic life.
                                Effective presentation skills enable individuals
                                to communicate ideas, information, and messages
                                in a clear,
                              </div>
                            </li>
                          </ul>
